/* rc3metal_brushed.pov version 2.1-beta.1
 ...
 * 1.2.1  2016-Mar-11  The lighting is replaced with calculated values from
 *                     ShapeOfTheDay (proposed for the Object Collection).
